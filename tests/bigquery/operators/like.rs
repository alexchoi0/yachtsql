...
fn test_like_prefix() {
    ...
    let result = session.execute_sql("SELECT 'hello' LIKE 'hel%'").unwrap();
...
fn test_like_suffix() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT 'hello' LIKE '%llo'").unwrap();
    assert_table_eq!(result, [[true]]);
}
...
fn test_like_contains() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT 'hello' LIKE '%ell%'").unwrap();
    assert_table_eq!(result, [[true]]);
}
...
fn test_like_exact() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT 'hello' LIKE 'hello'").unwrap();
    assert_table_eq!(result, [[true]]);
}
...
fn test_like_no_match() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT 'hello' LIKE 'world%'").unwrap();
...
fn test_like_underscore_single_char() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT 'cat' LIKE 'c_t'").unwrap();
    assert_table_eq!(result, [[true]]);
}
...
fn test_like_multiple_underscores() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT 'hello' LIKE 'h___o'").unwrap();
    assert_table_eq!(result, [[true]]);
}
...
fn test_like_with_null() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT NULL LIKE 'test%'").unwrap();
...
fn test_like_empty_string() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT '' LIKE '%'").unwrap();
    assert_table_eq!(result, [[true]]);
}
...
fn test_like_only_percent() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT 'anything' LIKE '%'").unwrap();
    assert_table_eq!(result, [[true]]);
}
