...
fn test_and_true_true() {
    ...
    let result = session.execute_sql("SELECT TRUE AND TRUE").unwrap();
...
fn test_and_true_false() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT TRUE AND FALSE").unwrap();
...
fn test_and_false_false() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT FALSE AND FALSE").unwrap();
    assert_table_eq!(result, [[false]]);
}
...
fn test_or_true_true() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT TRUE OR TRUE").unwrap();
    assert_table_eq!(result, [[true]]);
}
...
fn test_or_true_false() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT TRUE OR FALSE").unwrap();
    assert_table_eq!(result, [[true]]);
}
...
fn test_or_false_false() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT FALSE OR FALSE").unwrap();
    assert_table_eq!(result, [[false]]);
}
...
fn test_not_true() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT NOT TRUE").unwrap();
    assert_table_eq!(result, [[false]]);
}
...
fn test_not_false() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT NOT FALSE").unwrap();
    assert_table_eq!(result, [[true]]);
}
...
fn test_and_with_null() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT TRUE AND NULL").unwrap();
...
fn test_and_false_null() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT FALSE AND NULL").unwrap();
    assert_table_eq!(result, [[false]]);
}
...
fn test_or_with_null() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT FALSE OR NULL").unwrap();
    assert_table_eq!(result, [[null]]);
}
...
fn test_or_true_null() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT TRUE OR NULL").unwrap();
    assert_table_eq!(result, [[true]]);
}
...
fn test_not_null() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT NOT NULL").unwrap();
    assert_table_eq!(result, [[null]]);
}
...
fn test_logical_with_comparison() {
    let mut session = create_session();
    let result = session.execute_sql("SELECT 5 > 3 AND 2 < 4").unwrap();
    assert_table_eq!(result, [[true]]);
}
...
fn test_not_in_where() {
    let mut session = create_session();
    session.execute_sql("CREATE TABLE flags (a BOOL)").unwrap();
    session
