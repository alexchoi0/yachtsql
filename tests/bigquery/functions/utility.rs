...
fn test_typeof_null() {
    let mut executor = create_executor();
    let result = executor.execute_sql("SELECT TYPEOF(NULL)").unwrap();
...
fn test_typeof_string() {
    let mut executor = create_executor();
    let result = executor.execute_sql("SELECT TYPEOF('hello')").unwrap();
...
fn test_typeof_int64() {
    let mut executor = create_executor();
    let result = executor.execute_sql("SELECT TYPEOF(12 + 1)").unwrap();
...
fn test_typeof_float64() {
    let mut executor = create_executor();
    let result = executor.execute_sql("SELECT TYPEOF(4.7)").unwrap();
...
fn test_typeof_bool() {
    let mut executor = create_executor();
    let result = executor.execute_sql("SELECT TYPEOF(TRUE)").unwrap();
...
fn test_typeof_bytes() {
    let mut executor = create_executor();
    let result = executor.execute_sql("SELECT TYPEOF(b'hello')").unwrap();
...
fn test_typeof_array() {
    let mut executor = create_executor();
    let result = executor.execute_sql("SELECT TYPEOF([1, 2, 3])").unwrap();
